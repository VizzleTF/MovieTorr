...
### 🔗 API интеграция
Приложение использует [TorAPI](https://github.com/Lifailon/TorAPI) в качестве шлюза для запросов к торрент-трекерам. Это позволяет:
- **Обходить блокировки** без необходимости использования VPN
- **Получать данные** с RuTracker, Kinozal, RuTor и NoNameClub
- **Использовать единый API** для всех трекеров
- **Обеспечивать стабильность** работы приложения
...
- **[TorAPI](https://github.com/Lifailon/TorAPI)** - шлюз для доступа к торрент-трекерам
